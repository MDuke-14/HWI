...
# Feriados móveis para 2025-2027 (Páscoa e dias relacionados)
MOVABLE_HOLIDAYS = {
    2025: [
        (3, 4, "Carnaval"),
...
def is_overtime_day(check_date: date) -> tuple:
    """
...
def get_billing_period_dates(reference_date: date = None) -> tuple:
    """
