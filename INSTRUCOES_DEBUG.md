...
```
https://work-tracking-mobile.preview.emergentagent.com/api/debug/db-info
```
...
1. Abrir a aplicação em produção: https://work-tracking-mobile.preview.emergentagent.com
